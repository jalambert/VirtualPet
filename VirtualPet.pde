...
void draw(){
 fill(100,200,0);
  ...
  fill(255,255,255);
  stroke(0,0,0);
  triangle(80,219,85,219,80,225);
  triangle(85,219,95,219,90,225);
  triangle(95,219,105,219,100,225);
  triangle(105,219,115,219,110,225);
  triangle(115,219,125,219,120,225);
  triangle(125,219,135,219,130,225);
  triangle(135,219,145,219,140,225);
  //teeth bottom
